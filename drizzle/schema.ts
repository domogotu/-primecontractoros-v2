...
export const agentRuns = mysqlTable("agent_runs", {
  ...
  relatedRecordId: int("relatedRecordId"),
  recordContext: text("recordContext"),
  ...
  executionStatus: mysqlEnum("executionStatus", ["not_started", "preview_ready", "authorized", "executing", "verified", "failed"]).default("not_started").notNull(),
  executionPreview: text("executionPreview"),
  executionAuthorizedBy: int("executionAuthorizedBy"),
  executionAuthorizedAt: timestamp("executionAuthorizedAt"),
  executionResult: text("executionResult"),
  executionVerifiedAt: timestamp("executionVerifiedAt"),
